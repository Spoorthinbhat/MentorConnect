...
//       "zxcbnm"
//     ],
//     "pastMentoringExperience": "fghjk",
//     "mentoringGoals": "dfghjk",
//     "linkedInLink": "sdfghjk",
//     "blogLink": "xcvbn",
//     "cost": 12345
//   };
...
//               </div>
//               <button className="bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-semibold px-6 py-3 rounded-xl shadow-lg transition-all duration-200 transform hover:scale-105">
//                 Request Class
//               </button>
//             </div>
//           </div>
...
//                   <LinkedinIcon className="w-6 h-6 text-sky-600" />
//                 </div>
...
//                   className="flex items-center space-x-3 text-gray-700 hover:text-blue-600 transition-colors p-3 rounded-lg hover:bg-blue-50">
//                   <LinkedinIcon className="w-5 h-5" />
//                   <span>LinkedIn Profile</span>
//                 </a>
//                 <a href={mentor.blogLink} target="_blank" rel="noopener noreferrer"
//                   className="flex items-center space-x-3 text-gray-700 hover:text-purple-600 transition-colors p-3 rounded-lg hover:bg-purple-50">
...
// export default function MentorProfilePage({ mentorId }) {
...
//   if (error) {
//     return <div>Error fetching mentor data: {error.message}</div>; // Error handling
//   }
...
//               <div className="relative">
//                 <img
//                   src="/api/placeholder/120/120" // You might want to use a dynamic image URL here
//                   alt={mentor.name}
//                   className="w-32 h-32 rounded-full object-cover border-4 border-white shadow-lg"
//                 />
//                 <div className="absolute -bottom-2 -right-2 bg-green-400 w-6 h-6 rounded-full border-2 border-white"></div>
...
//                 {mentor.professionalLinks.map((link, index) => (
...
// export default function MentorProfilePage() {
//   const id = "67276b326a297ffb0662fc36"; // Constant mentor ID
//   const [mentor, setMentor] = useState(null);
//   const [loading, setLoading] = useState(true);
//   const [error, setError] = useState(null);
